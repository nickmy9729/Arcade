...
TrueDriveEmulation := IniReadCheck(settingsFile, "Settings|" . romName, "TrueDriveEmulation", "false",,1)
...
currentFullScreen := IniRead(viceINI, ident, viceINIFullscreenKey)
currentAutostartPrgMode := IniRead(viceINI, ident, AutostartPrgMode)
currentDriveTrueEmulation := IniRead(viceINI, ident, DriveTrueEmulation)
currentJoyDevice1 := IniRead(viceINI, ident, JoyDevice1)
currentJoyDevice2 := IniRead(viceINI, ident, JoyDevice2)
...
If RegExMatch(romName,"i)\(USA\)|\(Canada\)")
...
currentUsePaddles := IniRead(viceINI, ident, "Mouse")
...
If (ident = "C64") {
	If !RegExMatch(romExtension,"i)\.d64|\.d71|\.d80|\.d81|\.d82|\.g64|\.g41|\.x64|\.t64|\.tap|\.crt|\.prg|\.vsf")
	...
	If RegExMatch(romExtension,"i)\.d64|\.d71|\.d80|\.d81|\.d82|\.g64|\.g41|\.x64|\.prg|\.vsf")
		Run(executable . params . " -autostart """ . romPath . "\" . romName . romExtension . ":" . LoadFile . """", emuPath)
	Else If RegExMatch(romExtension,"i)\.t64|\.tap")
...
Else If (ident = "PLUS4") {
	If !RegExMatch(romExtension, "i)\.prg|\.d64|\.t64|\.tap|\.crt|\.g64")
	...
	If RegExMatch(romExtension, "i)\.d64|\.g64|\.prg")
		Run(executable . params . " """ . romPath . "\" . romName . romExtension . """", emuPath)
	...
	If Command
	{
		...
		If RegExMatch(romExtension,"i)\.t64|\.tap")
		{
...
Else If (ident = "VIC20") {
	If !RegExMatch(romExtension, "i)\.prg|\.d64|\.t64|\.tap|\.crt|\.vsf")
...
Else If (ident = "C128") {
	If !RegExMatch(romExtension,"i)\.prg|\.d64|\.d81")
