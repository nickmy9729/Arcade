...
controls := IniReadCheck(settingsFile, romname, "controls","standard",,1)
...
lastControlUsedNaomi := IniReadCheck(settingsFile, "Settings", "LastControlUsedNaomi", "standard",,1)
lastControlUsedAtomiswave := IniReadCheck(settingsFile, "Settings", "LastControlUsedAtomiswave", "standard",,1)
globalShaderEffects := IniReadCheck(settingsFile, "Settings", "GlobalShaderEffects", "false",,1)
globalShaderName := IniReadCheck(settingsFile, "Settings", "GlobalShaderName", "",,1)
globalShaderMode := IniReadCheck(settingsFile, "Settings", "GlobalShaderMode", "",,1)

loadDecrypted := IniReadCheck(settingsFile, romName, "LoadDecrypted", "",,1)
bios := IniReadCheck(settingsFile, romName, "Bios", "",,1)
shaderEffects := IniReadCheck(settingsFile, romName, "ShaderEffects", "",,1)
shaderName := IniReadCheck(settingsFile, romName, "ShaderName", "",,1)
shaderMode := IniReadCheck(settingsFile, romName, "ShaderMode", "",,1)

n_push1_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push1", "",,1)
n_push2_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push2", "",,1)
n_push3_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push3", "",,1)
n_push4_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push4", "",,1)
n_push5_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push5", "",,1)
n_push6_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push6", "",,1)
n_push7_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push7", "",,1)
n_push8_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "push8", "",,1)
n_service_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "SERVICE", "",,1)
n_start_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "START", "",,1)
n_coin_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "COIN", "",,1)
n_digitalup_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "DIGITALUP", "",,1)
n_digitaldown_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "DIGITALDOWN", "",,1)
n_digitalleft_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "DIGITALLEFT", "",,1)
n_digitalright_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "DIGITALRIGHT", "",,1)
n_analogup_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGUP", "",,1)
n_analogdown_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGDOWN", "",,1)
n_analogleft_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGLEFT", "",,1)
n_analogright_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGRIGHT", "",,1)
n_analogup2_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGUP2", "",,1)
n_analogdown2_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGDOWN2", "",,1)
n_analogleft2_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGLEFT2", "",,1)
n_analogright2_0 := IniReadCheck(settingsFile, controls . "_JAMMA0_0", "ANALOGRIGHT2", "",,1)

n_push1_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push1", "",,1)
n_push2_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push2", "",,1)
n_push3_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push3", "",,1)
n_push4_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push4", "",,1)
n_push5_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push5", "",,1)
n_push6_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push6", "",,1)
n_push7_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push7", "",,1)
n_push8_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "push8", "",,1)
n_service_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "SERVICE", "",,1)
n_start_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "START", "",,1)
n_coin_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "COIN", "",,1)
n_digitalup_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "DIGITALUP", "",,1)
n_digitaldown_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "DIGITALDOWN", "",,1)
n_digitalleft_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "DIGITALLEFT", "",,1)
n_digitalright_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "DIGITALRIGHT", "",,1)
n_analogup_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGUP", "",,1)
n_analogdown_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGDOWN", "",,1)
n_analogleft_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGLEFT", "",,1)
n_analogright_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGRIGHT", "",,1)
n_analogup2_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGUP2", "",,1)
n_analogdown2_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGDOWN2", "",,1)
n_analogleft2_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGLEFT2", "",,1)
n_analogright2_1 := IniReadCheck(settingsFile, controls . "_JAMMA0_1", "ANALOGRIGHT2", "",,1)

a_up_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "UP", "",,1)
a_down_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "DOWN", "",,1)
a_left_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "LEFT", "",,1)
a_right_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "RIGHT", "",,1)
a_shot1_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "SHOT1", "",,1)
a_shot2_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "SHOT2", "",,1)
a_shot3_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "SHOT3", "",,1)
a_shot4_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "SHOT4", "",,1)
a_shot5_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "SHOT5", "",,1)
a_start_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "START", "",,1)
a_coin_0 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_0", "COIN", "",,1)

a_up_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "UP", "",,1)
a_down_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "DOWN", "",,1)
a_left_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "LEFT", "",,1)
a_right_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "RIGHT", "",,1)
a_shot1_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "SHOT1", "",,1)
a_shot2_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "SHOT2", "",,1)
a_shot3_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "SHOT3", "",,1)
a_shot4_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "SHOT4", "",,1)
a_shot5_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "SHOT5", "",,1)
a_start_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "START", "",,1)
a_coin_1 := IniReadCheck(settingsFile, controls . "_ATOMISWAVE0_1", "COIN", "",,1)
