...
{
  float3 c  = tex2D(s_p, VAR.CT   ).xyz;
  float3 o1 = tex2D(s_p, VAR.t1.xy).xyz;
  float3 o2 = tex2D(s_p, VAR.t1.zw).xyz;
  float3 o3 = tex2D(s_p, VAR.t2.xy).xyz;
  float3 o4 = tex2D(s_p, VAR.t2.zw).xyz;
  float3 i1 = tex2D(s_p, VAR.t3.xy).xyz;
  float3 i2 = tex2D(s_p, VAR.t3.zw).xyz;
  float3 i3 = tex2D(s_p, VAR.t4.xy).xyz;
  float3 i4 = tex2D(s_p, VAR.t4.zw).xyz;
  float3 s1 = tex2D(s_p, VAR.t5.xy).xyz;
  float3 s2 = tex2D(s_p, VAR.t5.zw).xyz;
  float3 s3 = tex2D(s_p, VAR.t6.xy).xyz;
  float3 s4 = tex2D(s_p, VAR.t6.zw).xyz;
