...
{
   float3 c00 = tex2D(s_w, VAR.t1.zw).xyz; 
   float3 c10 = tex2D(s_w, VAR.t3.xy).xyz; 
   float3 c20 = tex2D(s_w, VAR.t3.zw).xyz; 
   float3 c01 = tex2D(s_w, VAR.t1.xy).xyz; 
   float3 c11 = tex2D(s_w, VAR.CT).xyz; 
   float3 c21 = tex2D(s_w, VAR.t2.xy).xyz; 
   float3 c02 = tex2D(s_w, VAR.t2.zw).xyz; 
   float3 c12 = tex2D(s_w, VAR.t4.xy).xyz; 
   float3 c22 = tex2D(s_w, VAR.t4.zw).xyz;
