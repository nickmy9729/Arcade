/* ############################################################################################
   ...
   2xAA+SF1 shader - Copyright (C) 2012 guest(r) - guest.r@gmail.com
...
VERTEX_STUFF0 _VERTEX (float3 p : POSITION, float2 tc : TEXCOORD0)
{
...
float4 _FRAGMENT ( in VERTEX_STUFF0 VAR ) : COLOR
{
...

{
  ...
  float3 dif = mx1-mn1;	
  float filterparam = clamp(8.0*length(dif)-1.5,1.0,4.0);
